...
from elastalert.alerts import AlertmanagerAlerter
...
from elastalert.alerts import RocketChatAlerter
from elastalert.alerts import SlackAlerter
from elastalert.alerts import TwilioAlerter
...
def test_twilio(caplog):
    ...
    with mock.patch('elastalert.alerts.TwilioClient.messages') as mock_twilio:
...
def test_rocketchat_msg_color(msg_color, except_msg_color):
    rule = {
        ...
        'type': 'any',
        'rocket_chat_webhook_url': 'http://please.dontgohere.rocketchat',
        'rocket_chat_username_override': 'elastalert',
        'alert_subject': 'Cool subject',
        'alert': []
    }
...
def test_rocketchat_attach_kibana_discover_url_when_generated():
    rule = {
        'name': 'Test Rule',
        'type': 'any',
        'alert_subject': 'Cool subject',
...
def test_rocketchat_attach_kibana_discover_url_when_not_generated():
    rule = {
        'name': 'Test Rule',
        'type': 'any',
        'alert_subject': 'Cool subject',
...
def test_rocketchat_kibana_discover_title():
    rule = {
        'name': 'Test Rule',
        'type': 'any',
        'alert_subject': 'Cool subject',
...
def test_rocketchat_kibana_discover_color():
    rule = {
        'name': 'Test Rule',
        'type': 'any',
...
def test_rocketchat_ca_certs(ca_certs, ignore_ssl_errors, excpet_verify):
    rule = {
        'name': 'Test Rule',
        'type': 'any',
        'rocket_chat_webhook_url': 'http://please.dontgohere.rocketchat',
...
def test_rocketchat_uses_custom_timeout():
    rule = {
        'name': 'Test Rule',
        'type': 'any',
        'rocket_chat_webhook_url': 'http://please.dontgohere.rocketchat',
