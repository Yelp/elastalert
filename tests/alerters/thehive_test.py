...
def test_thehive_alerter_with_dynamic_args():
    rule = {'alert': [],
            'alert_text': 'my desc {}',
            'alert_text_type': 'alert_text_only',
            'description': 'test',
            'hive_alert_config': {'customFields': [{'name': 'test',
                                                    'type': 'string',
                                                    'value': 2}],
                                  'description_args': ['test.some_desc'],
                                  'follow': True,
                                  'severity': 2,
                                  'source': 'elastalert {}',
                                  'source_args': ['test.some_source'],
                                  'status': 'New',
                                  'tags': ['test.port'],
                                  'title': 'my title {}',
                                  'title_args': ['test.some_title'],
                                  'tlp': 3,
                                  'type': 'external {}',
                                  'type_args': ['test.some_type']},
            'hive_connection': {'hive_apikey': '',
                                'hive_host': 'https://localhost',
                                'hive_port': 9000},
            'hive_observable_data_mapping': [{'ip': 'test.ip'}, {'autonomous-system': 'test.as_number'}],
    ...
    expected_data = {
        ...
        "description": "my desc ghi\n\n",
        "follow": True,
        "severity": 2,
        "source": "elastalert xyz",
        "status": "New",
        "tags": [
            "9876"
        ],
