# Deprecated ElastAlert README

*The documentation below refers to a previous ElastAlert version. For the latest version, see [here][0]*
...
[0]: https://github.com/jertel/elastalert/blob/alt/README.md
