...
+==========================================+=====+===========+===========+========+===========+=======+==========+
| es_host (string, no default)             | Req |    Req    |   Req     |  Req   |    Req    | Req   |   Req    |
+------------------------------------------+-----+-----------+-----------+--------+-----------+-------+----------+
| es_port (number, no default)             | Req |    Req    |   Req     |  Req   |    Req    | Req   |   Req    |
+------------------------------------------+-----+-----------+-----------+--------+-----------+-------+----------+
| index (string, no default)               | Req |    Req    |   Req     |  Req   |    Req    | Req   |   Req    |
+------------------------------------------+-----+-----------+-----------+--------+-----------+-------+----------+
| name (string, no default)                | Req |    Req    |   Req     |  Req   |    Req    | Req   |   Req    |
+------------------------------------------+-----+-----------+-----------+--------+-----------+-------+----------+
| type (string, no default)                | Req |    Req    |   Req     |  Req   |    Req    | Req   |   Req    |
+------------------------------------------+-----+-----------+-----------+--------+-----------+-------+----------+
| alert (string, no default)               | Req |    Req    |   Req     |  Req   |    Req    | Req   |   Req    |
+------------------------------------------+-----+-----------+-----------+--------+-----------+-------+----------+
| use_ssl (boolean, no default)            | Opt |    Opt    |   Opt     |  Opt   |    Opt    | Opt   |   Opt    |
+------------------------------------------+-----+-----------+-----------+--------+-----------+-------+----------+
| es_username (string, no default)         | Opt |    Opt    |   Opt     |  Opt   |    Opt    | Opt   |   Opt    |
+------------------------------------------+-----+-----------+-----------+--------+-----------+-------+----------+
| es_password (string, no default)         | Opt |    Opt    |   Opt     |  Opt   |    Opt    | Opt   |   Opt    |
+------------------------------------------+-----+-----------+-----------+--------+-----------+-------+----------+

+----------------------------------+-----------+---+---------+---------+------+---------+-----+--------+
|              FOR ALL RULES       |           |Any|Blacklist|Whitelist|Change|Frequency|Spike|Flatline|
+==================================+===========+===+=========+=========+======+=========+=====+========+
| es_host (string)                 |           |                                                       |
+----------------------------------+           +                                                       +
| es_port (number)                 | Required  |                                                       |
+----------------------------------+-----------+---+---------+---------+------+---------+-----+--------+
| use_ssl (boolean, no default)    | Optional  |                                                       |
+----------------------------------+           +                                                       +
...
+----------------------------------+-----------+---+---------+---------+------+---------+-----+--------+
| use_strftime_index (boolean)     | Optional  |                                                       |
+----------------------------------+-----------+---+---------+---------+------+---------+-----+--------+
...
| alert (string)                   |           |                                                       |
+----------------------------------+-----------+---+---------+---------+------+---------+-----+--------+
|aggregation (time, default:none)  | Optional  |                                                       |
+----------------------------------+           +                                                       +
